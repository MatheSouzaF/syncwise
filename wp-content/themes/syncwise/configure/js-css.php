...
function _add_javascript()
{
  ...
  wp_enqueue_script('plyr', 'https://cdn.jsdelivr.net/npm/plyr@3.7.8/dist/plyr.min.js', ['jquery'], null, true);
...
function _add_stylesheets()
{
  ...
  wp_dequeue_style('classic-theme-styles');
   wp_enqueue_style('plyr', 'https://cdn.jsdelivr.net/npm/plyr@3.7.8/dist/plyr.css');
